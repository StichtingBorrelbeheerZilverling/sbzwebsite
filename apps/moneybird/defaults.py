...
def make_order(costumer_name: str, orderlines: list):
    ...
    return {
        ...
        "currencyId": "",
        "customerCountryId": "",
        "customerId": costumer.moneybird_id,
        "deliveryConditionId": "",
...
def make_orderline(product_id: int, amount: float, drink_name: str, date_drink: str, discount: bool):
    ...
    from apps.moneybird import views
    return OrderLine(date_drink, drink_name,
                     # accountId=product.moneybird_id,
                     ...
                     description="{} - {}".format(product.moneybird_name, drink_name[:30]),
                     ...
                     pickListText=False,
                     # pricePer=1,
                     productId=product.moneybird_id,
                     quantityBackorder=0,
...
#       "vatCodeId": 0,
#     }
# TODO: Remove or rewrite to moneybird 
costumer_IA = {
    "accountManagerId": "",
    "addresses": [],
    "messages": [],
